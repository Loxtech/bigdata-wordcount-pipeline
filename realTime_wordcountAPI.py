...
def transform_and_save_to_hdfs(hdfs_input_path, hdfs_output_path, output_filename):
...
if __name__ == "__main__":
    ...
    transform_and_save_to_hdfs(hdfs_input_path + "/" + input_filename, hdfs_output_path, output_filename)
